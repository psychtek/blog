...
#### Average Suicide Rate per Generation
...
a scatter plot of that age group over time. 
...
Interestly, men aged between 35 - 54 years old have the strongest effect on the number of suicides followed by older generation then young adults. 
...
Similar pattern in Australia. Men aged 35 - 54 years old have the highest suicide rate. This is a concern as there are plenty of mental health networks available to people for access however, either these arent accessed enough or men arent simply seeking the help in the first place. 
